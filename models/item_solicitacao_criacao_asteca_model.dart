...
class ItemSolicitacaoCriacaoAstecaModel {
  ...
  ItemSolicitacaoCriacaoAstecaModel(
  ...
  factory ItemSolicitacaoCriacaoAstecaModel.fromJson(Map<String, dynamic> json) {
    return ItemSolicitacaoCriacaoAstecaModel(
